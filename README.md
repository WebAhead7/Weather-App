...
## ProTips
1. When you are coding the application imagine that you are a freelancer developer developing an application for an important customer.

2. The app must be ready to deploy and work flawlessly.

3. The app must be easy to work and and git info.

4. Detailed instructions to run the app should be included in your forked version because a customer would expect detailed instructions also.
